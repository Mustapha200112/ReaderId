    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('First Name: ${mrzResult.expiryDate}'),
            Text('Last Name: ${mrzResult.birthDate}'),
...
class NfcScanreadeState extends State<NfcScanreade> {
  ...
  void _tagReadCard() {
    ...
    NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
      ...
      if (isoDepTag != null) {
        String formattedBirthDate = formatDate(widget.mrzResult.birthDate);
        String formattedExpiryDate = formatDate(widget.mrzResult.expiryDate);
        String dataFieldConcat = widget.mrzResult.documentNumber +
            formattedBirthDate +
            formattedExpiryDate;
        List<int> dataFieldByte = utf8.encode(dataFieldConcat);
        ...
        try {
          ...
          Uint8List requestSelect = Uint8List.fromList([
            ...
            dataFieldByte
                .length, // Length of data field (Number of bytes to follow)
            ...dataFieldByte // Data field (File Identifier for National Identity Data)
          ]);
          ...
          Uint8List requestRecord = Uint8List.fromList([
            ...
            dataFieldByte
                .length, // Length of data field (Number of bytes to follow)
            ...dataFieldByte // Maximum number of bytes to read
          ]);
